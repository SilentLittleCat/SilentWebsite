	...
	{{ Form::token() }}
		...
		<div class="row field">
			...
			<div class="left floated left aligned fourteen wide column">
				<input type="text" name="name" placeholder="Input the movie name">
			</div>
		</div>
		<div class="row field">
			<label class="right floated right aligned two wide column">Director:</label>
			<div class="left floated left aligned fourteen wide column">
				<input type="text" name="director" placeholder="Input the movie's director">
			</div>
		</div>
		<div class="row field">
			<label class="right floated right aligned two wide column">Actors:</label>
			<div class="left floated left aligned fourteen wide column">
				<input type="text" name="actors" placeholder="Input movie's actors">
			</div>
		</div>
		<div class="row field">
			<label class="right floated right aligned two wide column">Poster:</label>
			<div class="left floated left aligned fourteen wide column">
				<input type="file" name="poster" id="poster" onchange="return moviePosterUpdate();">
		...
		<div class="row field">
			...
			<div class="left floated left aligned fourteen wide column">
				<div class="ui padded center aligned segment" id="previewImage"></div>
			</div>
		</div>
		<div class="row field">
			<label class="right floated right aligned two wide column">Description:</label>
			<div class="left floated left aligned fourteen wide column">
				<textarea rows="3" name="description" placeholder="Input a movie description"></textarea>
			</div>
		</div>
		<div class="row field">
			<label class="right floated right aligned two wide column">Recommend:</label>
			<div class="left floated left aligned fourteen wide column">
				<textarea rows="3" name="recommend" placeholder="Input a movie recommend"></textarea>
			</div>
		</div>
		<div class="row field">
			<label class="right floated right aligned two wide column">Ranking:</label>
			<div class="left floated left aligned fourteen wide column">
				<input type="number" name="ranking" placeholder="Input a movie ranking">
			</div>
		</div>
		<div class="row field">
			<label class="right floated right aligned two wide column">Stars:</label>
			<div class="left floated left aligned fourteen wide column">
				<input type="number" name="stars" class="column" placeholder="Input a movie stars">
			</div>
		</div>
		<div class="row field">
